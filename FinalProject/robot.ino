/*
 Intro to IM
 Final Project: An obstacle-avoiding robot Puffy
 April 29, 2021
 Written by Aiya Sartbayeva
*/

int message; //variable to store message which will transmit data to processing
